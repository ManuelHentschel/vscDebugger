...
export declare module StackTree {
    ...
    interface buildVariableReturn extends LazyTree.LazyNodeArgs {
        contentContent: Variable;
        childrenArgs: VariablesArgs;
        childrenChildren: {contentArgs: VariableArgs}[];
    }
    function buildVariable(args: VariableArgs): buildVariableReturn;

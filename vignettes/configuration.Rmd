...
* `"vsc.completionsNew" = TRUE`: Whether to use the new completion pipeline when typing in the debug console
* `"vsc.completionsLoadNamespaces" = FALSE`: Whether completion may load an otherwise unloaded package namespace
* `"vsc.completionsForceNamespacePromises" = FALSE`: Whether completion may force promises in package environments/namespaces, in particular lazy-loaded objects
...
* `"vsc.completionsFromVscDebugger" = FALSE`: Whether to use the legacy completions generated by the R package `vscDebugger` when typing in the debug console

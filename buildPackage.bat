...
"C:\Program Files\R\R-3.6.3\bin\R.exe" CMD INSTALL vscDebugger*.tar.gz --library=lib
...
"C:\Program Files\R\R-3.6.3\bin\R.exe" CMD INSTALL vscDebugger*.tar.gz --library=..\vscode-R-test\lib
